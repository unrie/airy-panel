...
class createController extends Controller {
	public function index() {
		...
		return $this->load->view('admin/tickets/categorys/create', $this->data);
	}
	...
	public function ajax() {
        ...
        $status = @$this->request->post['status'];
				...
				$categoryData = array(
					...
					'ticket_category_status'		=> $status
				);
				
				$this->ticketsCategorysModel->createTicketCategory($categoryData);
				
				$this->data['status'] = "success";
				$this->data['success'] = "Вы успешно создали категорию запросов!";
			} else {
				$this->data['status'] = "error";
