...
class viewController extends Controller {
	public function index($ticketid = null) {
		...
		$ticket = $this->ticketsModel->getTicketById($ticketid, array('users', 'tickets_categorys'));
		$messages = $this->ticketsMessagesModel->getTicketsMessages(array('ticket_id' => (int)$ticketid), array('users'));
		...
		if($this->request->server['REQUEST_METHOD'] == 'POST') {
			...
			if(!$errorPOST) {
				...
				if($closeticket) {
					...
					$mailLib->setSubject("Новый ответ в запросе #$ticketid");
