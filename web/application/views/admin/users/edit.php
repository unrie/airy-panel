...
<?php echo $header ?>
				...
				<div class="btn-group">
					<a href="/admin/servers/index?userid=<?php echo $user['user_id'] ?>" class="btn btn-default"><span class="glyphicon glyphicon-hdd"></span> Серверы пользователя</a>
					...
					<a href="/admin/authlogs/index?userid=<?php echo $user['user_id'] ?>" class="btn btn-default"><span class="glyphicon glyphicon-sort"></span> Логи авторизаций пользователя</a>
				</div>
				<form class="form-horizontal" action="#" id="editForm" method="POST">
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-9">
							<div class="checkbox">
								<label><input type="checkbox" id="editemail" name="editemail" onChange="toggleEmail()"> Изменить E-Mail</label>
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="email" name="email" placeholder="E-Mail" value="<?php echo $user['user_email'] ?>" disabled>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-4">
							<select class="form-control" id="mailing" name="mailing">
							  <option value="0"<?php if($user['user_mailing'] == 0): ?> selected="selected"<?php endif; ?>>Не получать новости на E-Mail</option>
							  <option value="1"<?php if($user['user_mailing'] == 1): ?> selected="selected"<?php endif; ?>>Получать новости на E-Mail</option>
				      </select>
						</div>
					</div>
					<h3>Пароль</h3>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<select class="form-control" id="theme" name="theme">
							  <option value="0"<?php if($user['user_theme'] == 0): ?> selected="selected"<?php endif; ?>>Светлая</option>
							  <option value="1"<?php if($user['user_theme'] == 1): ?> selected="selected"<?php endif; ?>>Темная</option>
				      </select>
						</div>
					</div>
					<div class="form-group">
				...
				<script>
					...
					function toggleEmail() {
						var status = $('#editemail').is(':checked');
						if(status) {
