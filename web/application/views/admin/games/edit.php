...
<?php echo $header ?>
				...
				<div class="btn-group">
					<a href="/admin/servers/index?locationid=<?php echo $game['game_id'] ?>" class="btn btn-default"><span class="glyphicon glyphicon-hdd"></span> Серверы игры</a>	<a class="btn btn-danger pull-right" href="/admin/games/edit/delete/<?php echo $game['game_id'] ?>">Удалить игру</a>
				</div>
				<form class="form-horizontal" action="#" id="editForm" method="POST">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label" for="imageurl">URL картинки:</label>
						<div class="col-sm-4">
							<input type="text" id="imageurl" name="imageurl" class="form-control" placeholder="URL картинки" value="<?php echo $game['game_image_url'] ?>">
						</div>
					</div>
