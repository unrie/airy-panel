...
<?php echo $header ?>
				...
				<form class="form-horizontal" action="#" id="createForm" method="POST">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="password" class="form-control" id="dbpassword" name="dbpassword" placeholder="Пароль БД">
						</div>
					</div>
					<div class="form-group">
						<label for="dbpassword2" class="col-sm-3 control-label">Повторите пароль БД:</label>
						<div class="col-sm-4">
							<input type="password" class="form-control" id="dbpassword2" name="dbpassword2" placeholder="Повторите пароль БД">
						</div>
					</div>
